...
CalibrationMatrix DmTouchCalibration::getDefaultCalibrationData(DmTouch::Display disp) {
  ...
  switch (disp) {
    ...
    case DmTouch::DM_TFT24_363:
          calibrationMatrix.a = 67997;
          calibrationMatrix.b = -191;
          calibrationMatrix.c = -22636386;
          calibrationMatrix.d = -85;
          calibrationMatrix.e = 87113;
          calibrationMatrix.f = -5334688;
          break;
